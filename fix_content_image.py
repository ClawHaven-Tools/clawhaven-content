...
m_id = upload_image("/home/william/.openclaw/media/tool-image-generation/content_first---22712108-2466-4dd6-a4ae-394d1da79083.jpg")
requests.post(
    f"{wp_url.rstrip('/')}/wp-json/wp/v2/posts/37",
    auth=auth,
    json={'featured_media': m_id}
)
print(f"Updated post 37 with media {m_id}")
